...
public class InvalidLogOnWithOutPageObject extends ParentTest { //Альт + Ентер чтоб создать конструктор нашего класса
    ...
    public void invalidLogOn() {
        ...
        //        .sendKeys("Student");
        logInPage.enterPasswordToInput("2222"); // заменили нижестоящий методом
        ...
        Assert.assertTrue("Assert work", webDriver.findElement(By.xpath(".//*[contains(text,'+text+')]")).isDisplayed()); //метод который спрашивает у драйвера нашел ли он элемент.

...
public class ConfigData {
    public static String cfgFile="src/config.properties";//путь у нас в проэкте
    public static String uiMappingFile="./src/UIMapping.properties2";//путь у нас в проэкте
